...
function ms_not_installed() {
	...
	if ( ! is_admin() )
		die( $msg );
	$msg .= '<p>' . /*WP_I18N_CONTACT_OWNER*/'Se o seu site não aparecer, entre em contrato com o proprietário da rede.'/*/WP_I18N_CONTACT_OWNER*/ . '';
	$msg .= ' ' . /*WP_I18N_CHECK_MYSQL*/'Se é o proprietário desta rede verifique se o MySQL está a funcionar correctamente e que todas as tabelas estão livre de erros.'/*/WP_I18N_CHECK_MYSQL*/ . '</p>';
